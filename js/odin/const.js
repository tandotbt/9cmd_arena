const URL_API_9CMD = "https://api.tanvpn.tk"
...
const url_jsonblod_data_arena_2 = `${URL_API_9CMD}/data_9cmd_arena?serverPlanet=${SERVER_PLANET_USE}&type=url_jsonblod_data_arena_2`;
const url_jsonblod_leadboard_2 = "https://jsonblob.com/api/1194537532422742016";
const url_jsonblod_time_block = `${URL_API_9CMD}/block?serverPlanet=${SERVER_PLANET_USE}`;
